...
StandardappGenerator.prototype.askFor = function askFor() {
  var cb = this.async();
...
StandardappGenerator.prototype.app = function app() {
  this.mkdir('app');
...
StandardappGenerator.prototype.projectfiles = function projectfiles() {
